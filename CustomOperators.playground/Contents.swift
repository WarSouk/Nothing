...
let fullName = firstName + lastName // it will work if we will change the optional string type in the variables
...
func + (
    ...
    lhs:String?) -> String? {
        ...
        case let (.some(value), .none),
            let (.none, .some(value)): // we can remove case let cause they have the same logic
            return value
